    ...
    try {
        ...
        userPosts.forEach(post => {
            if (post.reactions) {
                ...
                Object.values(post.reactions).forEach(reactionArray => {
                    // reactionArray - это массив ID пользователей
                    totalLikes += Array.isArray(reactionArray) ? reactionArray.length : 0;
                });
            }
        });
